  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-4 flex flex-col items-center gap-10 pt-10 relative">
       ...
       <div className="relative">
          <div className={`text-9xl font-sub tracking-tighter transition-colors duration-300 drop-shadow-2xl ${win ? 'text-brand-yellow' : result !== null ? 'text-brand-red' : 'text-slate-600'}`}>
       ...
       <div className="w-full max-w-md bg-card p-6 rounded-xl border border-slate-800 space-y-6 shadow-2xl">
             ...
             <div>
                ...
                <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full bg-background border border-slate-700 rounded-lg py-3 pl-7 pr-3 text-white font-sub text-lg"
                    />
                  </div>
             </div>
             <div>
                ...
                <div className="relative">
                    <input 
                      ...
                      className="w-full bg-background border border-slate-700 rounded-lg py-3 px-3 text-white font-sub text-lg"
                    />
          ...
          <button 
            onClick={handleBet}
            className="w-full bg-gradient-to-r from-brand-red to-brand-orange hover:brightness-110 text-white font-heading text-2xl py-4 rounded-lg shadow-[0_0_20px_rgba(206,32,41,0.3)] transition-transform active:scale-95"
          >
            BET
          </button>
       </div>
